...
async function submitFormResponse() {
  ...
  questionToAnswerMap[DUEDATE] = _dueDate;
  questionToAnswerMap[GARAGE] = _garage;
  questionToAnswerMap[PARTS] = _parts;
  questionToAnswerMap[COMMENT] = _comment;
...
function inflateOdometerDiv() {
  var textQuestionDiv = document.getElementById('odometerDiv');
  ...
  textQuestionTitle.innerText = _strings[_form.questions[ODOMETER].title];

  var textQuestionInput = KASClient.UI.getElement('input');
  textQuestionInput.type = 'number';
...
function inflateDueDateDiv() {
  var textQuestionDiv = document.getElementById('dueDatdeDiv');
  KASClient.UI.clearElement(textQuestionDiv);

  var textQuestionTitle = KASClient.UI.getElement('div');
  textQuestionTitle.className = 'question-title';
  textQuestionTitle.innerText = _strings[_form.questions[DUEDATE].title];
...
function inflateGarageDiv() {
  var question = _form.questions[GARAGE];

  var questionDiv = document.getElementById('incidentDiv');
  ...
  for (i = 0; i < question.options.length; i++) {
    ...
    options.onclick = function () {
      _garage = this.value;
      document.getElementById('SingleSelectOption' + _garage).checked = true;
      invalidateFooter();
    };
...
function inflatePartsDiv() {
  var textQuestionDiv = document.getElementById('partsDiv');
  KASClient.UI.clearElement(textQuestionDiv);

  var textQuestionTitle = KASClient.UI.getElement('div');
  textQuestionTitle.className = 'question-title';
  textQuestionTitle.innerText = _strings[_form.questions[PARTS].title];
...
function inflateStartingPointDiv() {
  ...
  var textQuestionTitle = KASClient.UI.getElement('div');
  textQuestionTitle.className = 'question-title';
  textQuestionTitle.innerText = _strings[_form.questions[COMMENT].title];
...
function inflateSummaryView() {
  ...
  odometerDetailsHeader.innerText = _strings[_form.questions[ODOMETER].title];
  ...
  duedateDetailsHeader.innerText = _strings[_form.questions[DUEDATE].title];
  ...
  duedate.innerHTML = _dueDate;

  KASClient.UI.addElement(duedate, duedateDetailsView);
  KASClient.UI.addElement(duedateDetailsView, duedateDetailsDiv);

  var singleSelectQuestionDetailsDiv = KASClient.UI.getElement(
    'div',
    divAttributes
  );

  var singleSelectQuestionDetailsHeader = KASClient.UI.getElement('div', {
    padding: '14px',
    'padding-bottom': '0pt',
  });

  singleSelectQuestionDetailsHeader.className = 'comment-header';
  singleSelectQuestionDetailsHeader.innerText =
    _strings[_form.questions[GARAGE].title];
  KASClient.UI.addElement(
    singleSelectQuestionDetailsHeader,
    singleSelectQuestionDetailsDiv
  );
  ...
  singleSelectQuestion.innerHTML =
    _strings[_form.questions[GARAGE].options[_garage].text];

  KASClient.UI.addElement(
    singleSelectQuestion,
    singleSelectQuestionDetailsView
  );
  KASClient.UI.addElement(
    singleSelectQuestionDetailsView,
    singleSelectQuestionDetailsDiv
  ...
  startingTripHeader.innerText = _strings[_form.questions[COMMENT].title];
  ...
  startingTrip.innerHTML = _comment;
  ...
  KASClient.UI.addElement(odometerDetailsDiv, summaryView);
  KASClient.UI.addElement(duedateDetailsDiv, summaryView);
  KASClient.UI.addElement(singleSelectQuestionDetailsDiv, summaryView);
  KASClient.UI.addElement(partsDetailsDiv, summaryView);
